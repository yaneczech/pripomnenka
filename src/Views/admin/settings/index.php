...
<form action="/admin/nastaveni" method="post">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h2 class="card-title"><i class="ri-store-2-line"></i> Kontaktni udaje</h2>
        </div>
        <div class="card-body">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h2 class="card-title"><i class="ri-bank-line"></i> Bankovni udaje</h2>
        </div>
        <div class="card-body">
            <div class="form-row form-row--2">
                <div class="form-group">
                    <label for="bank_account" class="form-label">Cislo uctu</label>
            ...
            <hr class="my-3">
            <h3 class="text-small mb-2"><i class="ri-mail-settings-line"></i> IMAP pro automaticke parovani plateb</h3>
            ...
            <div class="form-row form-row--3">
                ...
                <div class="form-group">
                    ...
                    <span class="form-hint">Nechte prazdne pro zachovani aktualniho</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h2 class="card-title"><i class="ri-timer-line"></i> Vychozi nastaveni</h2>
        </div>
        <div class="card-body">
            <div class="form-row form-row--2">
                <div class="form-group">
                    <label for="default_advance_days" class="form-label">Vychozi predstih pripominky (dny)</label>
                ...
                <div class="form-group">
                    <label for="activation_link_validity_days" class="form-label">Platnost aktivacniho odkazu (dny)</label>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h2 class="card-title"><i class="ri-mail-line"></i> Emailove sablony</h2>
        </div>
        <div class="card-body">
            <div class="form-group">
                <label for="email_activation_subject" class="form-label">Predmet: Aktivacni email</label>
            ...
            <div class="form-group">
                <label for="email_payment_qr_subject" class="form-label">Predmet: QR kod pro platbu</label>
            ...
            <div class="form-group">
                <label for="email_customer_reminder_subject" class="form-label">Predmet: Pripominka udalosti</label>
            ...
            <div class="form-group">
                <label for="email_customer_reminder_template" class="form-label">Sablona: Pripominka udalosti</label>
                ...
                <span class="form-hint">Promenne: {{name}}, {{event_type}}, {{recipient}}, {{date}}, {{shop_phone}}</span>
            </div>

            <div class="form-group">
                <label for="email_expiration_subject" class="form-label">Predmet: Expirace predplatneho</label>
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn--primary btn--large">
            <i class="ri-save-line"></i> Ulozit nastaveni
        </button>
    </div>
</form>
